...
<template>
  <view class="bg-transparent">
    <view class="z-10 w-full !fixed backdrop-blur-[6rpx]" :style="{ backgroundColor: `rgba(255, 255, 255, ${navBarOpacity})` }">
    ...
    <view class="flex flex-col bg-[linear-gradient(180deg,rgba(255,255,255,0)_0%,#ffffff_14%,#ffffff_100%)]">
      <view class="mx-24rpx mb-16rpx flex flex-col b-l-6rpx b-l-solid b-l-[#215476] pl-12rpx">
      ...
      <wd-card class="relative z-1 !mx-24rpx !rd-20rpx !shadow-[0_12rpx_26rpx_rgba(33,84,118,0.2)] bg-[linear-gradient(165deg,#d4e5ed_0%,#ffffff_34%,#ffffff_72%,#d8e8ef_100%)]">
        <template #title>
        ...
        <template #default>
          <view class="flex gap-16rpx pb-32rpx">
            <view class="flex-[2] flex flex-col gap-16rpx">
              <wd-text text="校友论坛" size="24rpx" color="#215476" class="[text-shadow:0_2rpx_8rpx_rgba(33,84,118,0.16)]" />
              <wd-img src="http://10.86.136.242:9000/images/index_forum.png" width="100%" class="aspect-square shadow-[0_8rpx_18rpx_rgba(33,84,118,0.22)]" mode="aspectFill" radius="14rpx" @click="goForumPage()" />
            </view>

            <view class="flex-[3] flex flex-col gap-16rpx">
              <wd-text text="VR座椅冠名" size="24rpx" color="#215476" class="[text-shadow:0_2rpx_8rpx_rgba(33,84,118,0.16)]" />
              <wd-img src="http://10.86.136.242:9000/images/index_vr.png" width="100%" height="100%" class="shadow-[0_8rpx_18rpx_rgba(33,84,118,0.22)]" mode="aspectFill" radius="14rpx" @click="goVRPage()" />
            </view>
          </view>
        </template>
      </wd-card>

      <wd-grid :column="4" class="mt--96rpx bg-white px-24rpx pt-112rpx rd-tl-28rpx rd-tr-28rpx">
        <wd-grid-item v-for="(item, index) in gridItemList" :key="index">
          <template #default>
            <view class="flex flex-col items-center justify-center gap-16rpx">
              <view class="size-100rpx flex items-center justify-center rounded-20rpx bg-[linear-gradient(165deg,#d4e5ed_0%,#ffffff_52%,#d8e8ef_100%)] shadow-[0_4rpx_10rpx_rgba(33,84,118,0.08)]">
                <view :class="item.icon" class="size-60rpx color-[#215476]" />
              </view>
      ...
      <view class="flex flex-col bg-white py-16rpx">
        <view class="mx-40rpx w-210rpx b-1rpx b-b-solid b-[#215476] p-4rpx">
          <wd-text text="武理快讯" class="italic" size="32rpx" color="#215476" bold />
        </view>
      </view>

      <view class="px-24rpx pb-8rpx flex flex-col gap-0 bg-white rd-12rpx overflow-hidden">
        <view
          v-for="(item, index) in activityList"
          :key="index"
          class="flex gap-16rpx rd-0 py-18rpx bg-transparent"
        ...
        >
          ...
          <view class="flex-1 min-w-0 flex flex-col justify-between">
            <view class="text-[#215476] text-28rpx font-600 leading-[1.35]">
              {{ item.title }}
            </view>
            <view class="mt-8rpx text-[#4b5563] text-20rpx leading-[1.45]">
              校友公益活动持续进行中，欢迎查看项目进展与参与方式。
            </view>

            <view class="mt-12rpx flex items-center justify-between gap-10rpx">
              <view class="flex items-center gap-6rpx">
                <view class="i-mdi-clock-time-four-outline w-22rpx h-22rpx color-[#6b7280]" />
